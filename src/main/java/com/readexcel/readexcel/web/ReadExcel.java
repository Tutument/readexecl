...
public class ReadExcel {
    ...
    public static void main(String[] args) {
        ...
        //readExcel("KS_044","单客户多银行协议（个人）","柜台无纸化签署接口文档v2.2.7对比.xlsx","D:\\\\jar");
       // readExcel("090006","中登TA账户查询","ESB对外接口文档1.2.1.xlsx","D:\\\\jar");
      // readExcel(args[0],args[1],args[2],args[3]);
    }

    public static void readExcel(String jiekouhao,String jiekouming,String xlsx,String path){
       // String excelPath = "D:\\jar\\柜台无纸化签署接口文档v2.2.7对比.xlsx";
        ...
        if(esb){
            if (excel.isFile() && excel.exists()) {
                ...
                stringBuffer.append("@InterfaceName(\"" + jiekouming + "\")\r\n");
            ...
            //开始解析
            //读取sheet
            int firstRowIndex = sheet.getFirstRowNum();   //协议比较坑，格式不确定，各种格式，一般都是前三行不读
            int lastRowIndex = sheet.getLastRowNum();
            StringBuffer sb1 = new StringBuffer();
            //去除前面的空列
            int rowIndex = 99999;
                ...
                if (row != null) {
                    ...
                    for (int cIndex = firstCellIndex; cIndex < lastCellIndex; cIndex++) {   //遍历列
                        ...
                        if(rIndex>rowIndex) {
                            ...
                            if (cIndex == ann) {
                                //StringBuffer的append在循环体String的+快很多，循环很大的情况下
                                if(cell.toString().length()>0)
                                    sb1.append("//" + cell.toString());
                                sb1.append("\r\n");
                            }
